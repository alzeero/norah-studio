      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className={cn(
              "relative z-10 w-full max-w-md rounded-xl2 border border-border bg-bg-elevated p-6 shadow-soft",
              className
            )}
          >
            <div className="mb-4 flex items-start justify-between gap-4">
              <div>
                <h2 id="dialog-title" className="text-heading font-medium text-fg">
                  {title}
                </h2>
